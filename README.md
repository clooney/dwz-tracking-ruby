# DWZ Express Tracking API For Ruby
DWZ Express Tracking API and webhook make it easy to integrate DWZ Express Tracking function into your own project. Support APIs Client Libraries for ruby

### API key

In order to use this API, you need to generate a DWZ Express Tracking  API key in the [TrackingMore](https://www.trackingmore.com).
...
------------------------------------------------------------------------------------------------------------------
[TrackingMore](https://www.trackingmore.com) is a multiple carrier solutions. Developers can get tracking results from 410+ couriers by integrating trackingmore API.Check the courier code. use DWZ Express Tracking API of Trackingmore  allows eCommerce developers in any sizes to add package tracking fuction easily. Use [DWZ Express Tracking API](https://www.trackingmore.com/dwz-tracking.html)  to:

   *   Get DWZ Express realtime tracking info of muti-carriers in one integration
   *   Provide DWZ Express shipment tracking experience like Amazon
   *   Push DWZ Express notifications of package update with webhook
   *   Verify DWZ Express delivery exception before it is too late
